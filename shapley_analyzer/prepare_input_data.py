...
def convert_map_to_arrays(map, feature_names):
    model_1, model_2, model_3 = [], [], []
    for feature in feature_names:
        model_1.append(map['model_1'][feature])
        model_2.append(map['model_2'][feature])
        model_3.append(map['model_3'][feature])
